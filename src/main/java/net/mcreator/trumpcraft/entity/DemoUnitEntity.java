...
public class DemoUnitEntity extends TrumpcraftModElements.ModElement {
	public static EntityType entity = null;
	public DemoUnitEntity(TrumpcraftModElements instance) {
		super(instance, 168);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("demo_unit")
						.setRegistryName("demo_unit");
		elements.entities.add(() -> entity);
		elements.items
				.add(() -> new SpawnEggItem(entity, -65536, -13421773, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("demo_unit"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("trumpcraft:textures/demounit.png");
				}
			};
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			M57PilumItem.shoot(this, target);
		}
	}
}
