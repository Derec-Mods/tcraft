...
public class PoliceGolemEntity extends TrumpcraftModElements.ModElement {
	public static EntityType entity = null;
	public PoliceGolemEntity(TrumpcraftModElements instance) {
		super(instance, 207);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1.4f, 2.7f)).build("police_golem")
						.setRegistryName("police_golem");
		elements.entities.add(() -> entity);
		elements.items.add(
				() -> new SpawnEggItem(entity, -13421773, -13421773, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("police_golem"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modeldeathsquadgolem(), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("trumpcraft:textures/policegolem.png");
				}
			};
		});
	}
