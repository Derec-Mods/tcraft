...
public class TheTrumpEntity extends TrumpcraftModElements.ModElement {
	public static EntityType entity = null;
	public TheTrumpEntity(TrumpcraftModElements instance) {
		super(instance, 80);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f))
						.build("thetrump").setRegistryName("thetrump");
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(MoneyBlockBlock.block, (int) (1)));
		}
		...
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("trumpcraft:hail"));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				TrumpSummonSquad75Procedure.executeProcedure($_dependencies);
			}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
				$_dependencies.put("world", world);
				KilledTrumpProcedure.executeProcedure($_dependencies);
			}
		}
