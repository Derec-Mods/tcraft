...
public class MoneyAssaultRifleItem extends TrumpcraftModElements.ModElement {
	@ObjectHolder("trumpcraft:money_assault_rifle")
	public static final Item block = null;
	@ObjectHolder("trumpcraft:entitybulletmoney_assault_rifle")
	public static final EntityType arrow = null;
	public MoneyAssaultRifleItem(TrumpcraftModElements instance) {
		super(instance, 179);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletmoney_assault_rifle").setRegistryName("entitybulletmoney_assault_rifle"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("money_assault_rifle");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("it cost 400 thousand dollars..."));
		}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("trumpcraft:textures/moneybullet.png");
