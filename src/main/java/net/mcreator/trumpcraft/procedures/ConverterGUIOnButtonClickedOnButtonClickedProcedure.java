...
public class ConverterGUIOnButtonClickedOnButtonClickedProcedure extends TrumpcraftModElements.ModElement {
	public ConverterGUIOnButtonClickedOnButtonClickedProcedure(TrumpcraftModElements instance) {
		super(instance, 109);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure ConverterGUIOnButtonClickedOnButtonClicked!");
			return;
		}
