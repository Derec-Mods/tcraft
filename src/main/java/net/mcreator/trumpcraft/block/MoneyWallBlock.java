...
public class MoneyWallBlock extends TrumpcraftModElements.ModElement {
	@ObjectHolder("trumpcraft:moneywall")
	public static final Block block = null;
	public MoneyWallBlock(TrumpcraftModElements instance) {
		super(instance, 150);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2f, 6f).lightValue(0).harvestLevel(1)
					.harvestTool(ToolType.AXE).notSolid());
			setRegistryName("moneywall");
		}
