...
public class Ruins4Structure extends TrumpcraftModElements.ModElement {
	public Ruins4Structure(TrumpcraftModElements instance) {
		super(instance, 50);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 125) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("trumpcraft", "ruins4"));
						if (template == null)
							return false;
