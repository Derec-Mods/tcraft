...
public class Ruins7Structure extends TrumpcraftModElements.ModElement {
	public Ruins7Structure(TrumpcraftModElements instance) {
		super(instance, 53);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 125) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("trumpcraft", "ruins7"));
						if (template == null)
							return false;
