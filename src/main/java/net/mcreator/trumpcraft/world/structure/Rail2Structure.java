...
public class Rail2Structure extends TrumpcraftModElements.ModElement {
	public Rail2Structure(TrumpcraftModElements instance) {
		super(instance, 171);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 5000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("trumpcraft", "rail2"));
						if (template == null)
							return false;
