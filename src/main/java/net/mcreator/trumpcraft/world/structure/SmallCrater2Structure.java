...
public class SmallCrater2Structure extends TrumpcraftModElements.ModElement {
	public SmallCrater2Structure(TrumpcraftModElements instance) {
		super(instance, 185);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("trumpcraft", "smallcrater2"));
						if (template == null)
							return false;
