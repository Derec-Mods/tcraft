...
public class Ruins12Structure extends TrumpcraftModElements.ModElement {
	public Ruins12Structure(TrumpcraftModElements instance) {
		super(instance, 90);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 300) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("trumpcraft", "ruins12"));
						if (template == null)
							return false;
