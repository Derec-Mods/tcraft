...
public class Ruins5Structure extends TrumpcraftModElements.ModElement {
	public Ruins5Structure(TrumpcraftModElements instance) {
		super(instance, 51);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 125) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("trumpcraft", "ruins5"));
						if (template == null)
							return false;
