...
public class Lab1Structure extends TrumpcraftModElements.ModElement {
	public Lab1Structure(TrumpcraftModElements instance) {
		super(instance, 72);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 0) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("trumpcraft", "lab1"));
						if (template == null)
							return false;
