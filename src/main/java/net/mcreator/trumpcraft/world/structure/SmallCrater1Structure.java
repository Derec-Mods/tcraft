...
public class SmallCrater1Structure extends TrumpcraftModElements.ModElement {
	public SmallCrater1Structure(TrumpcraftModElements instance) {
		super(instance, 184);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("trumpcraft", "smallcrater1"));
						if (template == null)
							return false;
