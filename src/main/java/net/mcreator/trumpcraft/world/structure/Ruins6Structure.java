...
public class Ruins6Structure extends TrumpcraftModElements.ModElement {
	public Ruins6Structure(TrumpcraftModElements instance) {
		super(instance, 52);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 125) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("trumpcraft", "ruins6"));
						if (template == null)
							return false;
