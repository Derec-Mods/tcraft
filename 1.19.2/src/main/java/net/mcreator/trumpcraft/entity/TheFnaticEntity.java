...
public class TheFnaticEntity extends Monster {
	...
	public TheFnaticEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TrumpcraftModEntities.THE_FNATIC.get(), world);
	}

	public TheFnaticEntity(EntityType<TheFnaticEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 75;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		DestroyedHexProcedure.execute(this.level);
	}

	@Override
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		SpawnGroupData retval = super.finalizeSpawn(world, difficulty, reason, livingdata, tag);
		TrumpIncrementOnInitialEntitySpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ());
		return retval;
	}
