...
public class DeathSquadGolemEntity extends Monster {
	public DeathSquadGolemEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TrumpcraftModEntities.DEATH_SQUAD_GOLEM.get(), world);
	}

	public DeathSquadGolemEntity(EntityType<DeathSquadGolemEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 15;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(TrumpcraftModEntities.DEATH_SQUAD_GOLEM.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
