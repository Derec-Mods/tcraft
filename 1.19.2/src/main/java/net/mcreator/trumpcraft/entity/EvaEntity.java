...
public class EvaEntity extends Monster {
	...
	public EvaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TrumpcraftModEntities.EVA.get(), world);
	}
	...
	public SoundEvent getDeathSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("trumpcraft:theevadeath"));
	}
