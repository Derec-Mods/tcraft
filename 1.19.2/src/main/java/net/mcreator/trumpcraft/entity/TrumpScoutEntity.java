...
public class TrumpScoutEntity extends Monster {
	public TrumpScoutEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TrumpcraftModEntities.TRUMP_SCOUT.get(), world);
	}

	public TrumpScoutEntity(EntityType<TrumpScoutEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 5;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(TrumpcraftModEntities.TRUMP_SCOUT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
