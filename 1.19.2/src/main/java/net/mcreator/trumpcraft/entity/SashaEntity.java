...
public class SashaEntity extends Monster {
	...
	public SashaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TrumpcraftModEntities.SASHA.get(), world);
	}

	public SashaEntity(EntityType<SashaEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 50;
		setNoAi(false);
	...
	public SoundEvent getDeathSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("trumpcraft:awp"));
	}
