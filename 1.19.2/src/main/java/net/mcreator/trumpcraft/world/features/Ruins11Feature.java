...
public class Ruins11Feature extends Feature<NoneFeatureConfiguration> {
	public static Ruins11Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Ruins11Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("trumpcraft:ruins_11", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("trumpcraft:ruins_11", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("trumpcraft", "ruins11"));
		if (template == null)
			return false;
