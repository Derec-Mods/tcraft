...
public class TrumpShelterFeature extends Feature<NoneFeatureConfiguration> {
	public static TrumpShelterFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new TrumpShelterFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("trumpcraft:trump_shelter", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("trumpcraft:trump_shelter", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("trumpcraft", "bunker"));
		if (template == null)
			return false;
