...
public class Ruins12Feature extends Feature<NoneFeatureConfiguration> {
	public static Ruins12Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Ruins12Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("trumpcraft:ruins_12", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("trumpcraft:ruins_12", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("trumpcraft", "ruins12"));
		if (template == null)
			return false;
