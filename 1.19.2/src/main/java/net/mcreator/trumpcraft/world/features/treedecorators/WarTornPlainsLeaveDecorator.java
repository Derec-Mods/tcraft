...
public class WarTornPlainsLeaveDecorator extends LeaveVineDecorator {
	public static final WarTornPlainsLeaveDecorator INSTANCE = new WarTornPlainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("war_torn_plains_tree_leave_decorator", tdt);
	}

	public WarTornPlainsLeaveDecorator() {
		super(0.25f);
	}
