...
public class MoneyLakeLeaveDecorator extends LeaveVineDecorator {
	public static final MoneyLakeLeaveDecorator INSTANCE = new MoneyLakeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("money_lake_tree_leave_decorator", tdt);
	}

	public MoneyLakeLeaveDecorator() {
		super(0.25f);
	}
