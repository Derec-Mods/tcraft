...
public class MoneyBlockBlock extends Block {
	...
	public MoneyBlockBlock() {
		super(BlockBehaviour.Properties.of(Material.STONE).sound(SoundType.METAL).strength(25f, 3f));
	...
	public void attack(BlockState blockstate, Level world, BlockPos pos, Player entity) {
		...
		MoneyBlockPlayerStartsToDestroyProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), entity);
	}
}
