...
import net.mcreator.trumpcraft.procedures.FnaticWeaponBulletHitsPlayerProcedure;
...
public class FnaticWeaponItem extends TrumpcraftModElements.ModElement {
	@ObjectHolder("trumpcraft:fnatic_weapon")
	public static final Item block = null;
	@ObjectHolder("trumpcraft:entitybulletfnatic_weapon")
	public static final EntityType arrow = null;
	public FnaticWeaponItem(TrumpcraftModElements instance) {
		super(instance, 167);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletfnatic_weapon").setRegistryName("entitybulletfnatic_weapon"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ItemGroup.COMBAT).maxDamage(4000));
			setRegistryName("fnatic_weapon");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("No. It's not from Terraria."));
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			World world = this.world;
			{
				...
				FnaticWeaponBulletHitsPlayerProcedure.executeProcedure($_dependencies);
			}
		}
