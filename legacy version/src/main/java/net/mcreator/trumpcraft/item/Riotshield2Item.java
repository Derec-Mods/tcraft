...
public class Riotshield2Item extends TrumpcraftModElements.ModElement {
	@ObjectHolder("trumpcraft:riotshield_2")
	public static final Item block = null;
	public Riotshield2Item(TrumpcraftModElements instance) {
		super(instance, 198);
	}
