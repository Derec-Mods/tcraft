...
public class TrumpSoldierEntity extends TrumpcraftModElements.ModElement {
	public static EntityType entity = null;
	public TrumpSoldierEntity(TrumpcraftModElements instance) {
		super(instance, 9);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f))
						.build("trumpsoldier").setRegistryName("trumpsoldier");
		elements.entities.add(() -> entity);
		elements.items.add(
				() -> new SpawnEggItem(entity, -16777216, -16722247, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("trumpsoldier"));
	}
