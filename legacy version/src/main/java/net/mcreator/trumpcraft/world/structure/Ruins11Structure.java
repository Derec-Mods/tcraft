...
public class Ruins11Structure extends TrumpcraftModElements.ModElement {
	public Ruins11Structure(TrumpcraftModElements instance) {
		super(instance, 89);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 300) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("trumpcraft", "ruins11"));
						if (template == null)
							return false;
