...
public class Ruins9Structure extends TrumpcraftModElements.ModElement {
	public Ruins9Structure(TrumpcraftModElements instance) {
		super(instance, 55);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 125) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("trumpcraft", "ruins9"));
						if (template == null)
							return false;
