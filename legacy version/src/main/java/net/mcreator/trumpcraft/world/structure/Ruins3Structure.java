...
public class Ruins3Structure extends TrumpcraftModElements.ModElement {
	public Ruins3Structure(TrumpcraftModElements instance) {
		super(instance, 49);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 125) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("trumpcraft", "ruins3"));
						if (template == null)
							return false;
