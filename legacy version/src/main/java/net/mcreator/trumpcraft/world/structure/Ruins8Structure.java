...
public class Ruins8Structure extends TrumpcraftModElements.ModElement {
	public Ruins8Structure(TrumpcraftModElements instance) {
		super(instance, 54);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 125) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("trumpcraft", "ruins8"));
						if (template == null)
							return false;
