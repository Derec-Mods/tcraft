...
public class Ruins10Structure extends TrumpcraftModElements.ModElement {
	public Ruins10Structure(TrumpcraftModElements instance) {
		super(instance, 88);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 300) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("trumpcraft", "ruins10"));
						if (template == null)
							return false;
