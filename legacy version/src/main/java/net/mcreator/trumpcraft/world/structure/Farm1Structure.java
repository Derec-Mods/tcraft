...
public class Farm1Structure extends TrumpcraftModElements.ModElement {
	public Farm1Structure(TrumpcraftModElements instance) {
		super(instance, 91);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 1000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("trumpcraft", "farm1"));
						if (template == null)
							return false;
