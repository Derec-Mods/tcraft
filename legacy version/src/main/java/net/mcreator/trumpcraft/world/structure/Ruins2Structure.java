...
public class Ruins2Structure extends TrumpcraftModElements.ModElement {
	public Ruins2Structure(TrumpcraftModElements instance) {
		super(instance, 28);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 125) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("trumpcraft", "ruins1"));
						if (template == null)
							return false;
