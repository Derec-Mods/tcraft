...
public class Bunker4Structure extends TrumpcraftModElements.ModElement {
	public Bunker4Structure(TrumpcraftModElements instance) {
		super(instance, 24);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 700) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("trumpcraft", "bunker3"));
						if (template == null)
							return false;
